<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manageBuildings.aspx.cs" Inherits="centroEscolar.gentelella_master.production.manageBuildings" MasterPageFile="~/gentelella-master/production/Site1.Master" %>

<asp:content id="Content2" ContentPlaceHolderID="head" runat="server">
	<title>Gestionar edificios</title>
...
<asp:content id="Content1" ContentPlaceHolderID="bodyContent" runat="server">	
	<div class="x_panel">
		<div class="x_content">
			<h2 id="labelMsjAction">Agregar edificio</h2>
			<br>
			<form id="form1" class=" g-3 needs-validation" novalidate>
				<div class="row" style="margin-top:20px">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xsm-12 form-group">
						<label class="control-label">Nombre</label>
						<input style="border-radius:6px" type="text" class="form-control has-feedback-left " required="required" name="edificio" id="edificio" placeholder="Nombre del edificio" onkeyup="onkeyupInputEmtyy('edificio')">
						<div class="valid-feedback">
							¡ Buen trabajo!
						</div>
						<div class="invalid-feedback">
							Nombre del edificio es requerido
						</div>
						<span class="fa fa-user form-control-feedback left" aria-hidden="true" style="margin-top: 30px;"></span>
					</div>								
					<div class="form-group col-lg-6 col-md-6 col-sm-6 col-xsm-12">
						<label class="control-label">Carreras</label>
						<select style="border-radius:6px" class="form-control" id="carreras" required="required" name="carrera" onchange="onkeyupNoSelectInSlc('carreras')">
						...
						<div class="invalid-feedback">
							Seleccione una opción correcta en carreras
						</div>
					</div>
					<div class="form-group row" style="margin-top:20px;">
						<div class="col-md-7 col-sm-7" id="ctrl-principal">								
							<button class="btn btnDeletes reflejo" id="delete" type="button" onclick="deleteBuildings(event)">
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
									<path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"></path>                                    
								</svg>
								Eliminar
							</button>
							<button type="button" class="btn btnSuccesss reflejo" id="add" onclick="addEdif()">
					...
					<input type="hidden" name="catalogo" value="edificios" />
				</div>
			</form>
			<div style="margin-top:30px;" class="x_title"></div>
			<h2>Edificios<small></small></h2>
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-6" style="margin-top:10px">
					...
					<select class="form-control" id="filterBySlc" required="required" onchange="buildingsXcarrera()">
						<option selected value="">Carreras...</option>
			...
			<div id="containerTableBuildings"></div>			
			<%-- Tabla Final--%>
		</div>
	</div>

    <script src="js/personalizados/buildings/add.js"></script>
    <script src="js/personalizados/buildings/buildTable.js"></script>
    <script src="js/personalizados/buildings/delete.js"></script>
    <script src="js/personalizados/buildings/OnkeyupSearch.js"></script>
    <script src="js/personalizados/buildings/recoverData.js"></script>
    <script src="js/personalizados/buildings/update.js"></script>
    <script src="js/personalizados/buildings/buildingsXcarrera.js"></script>
    <script src="js/personalizados/buildings/ajax/recoverDataBuildingsXcarrer.js"></script>
    <script src="js/personalizados/listeners/buildings/tableBuildimgs.js"></script>
