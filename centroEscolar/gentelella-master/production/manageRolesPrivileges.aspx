<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manageRolesPrivileges.aspx.cs" Inherits="centroEscolar.gentelella_master.production.manageRolesPrivileges" MasterPageFile="~/gentelella-master/production/Site1.Master" %>
...
<asp:content id="Content2" ContentPlaceHolderID="head" runat="server">
	...
	<title>Privilegios sobre roles</title>
</asp:content> 

<asp:content id="Content1" ContentPlaceHolderID="bodyContent" runat="server">	
	<div class="x_panel">
		<div class="x_content">
			<h2 id="labelMsjAction">Agregar privilegios a roles</h2>
			<br>
			<form id="form1" class="g-3 needs-validation" novalidate>
				<div class="form-group row">
					<label class="control-label col-md-2 col-sm-3 ">Roles</label>
					<div class="col-md-7 col-sm-9 ">
						<select class="form-control" id="roles" required="required" name="roles">
				...
				<div class="row" style="margin-top:20px">
					<div class="col-lg-3 col-md-12 col-sm-12" style="margin-right:15px" >
						<div class="form-check">
							<input style="padding:10px" id="checkFull" class="form-check-input" type="checkbox" onchange="checkFullPrivileges()">
				...
				{%>       <h4 style="margin-top:25px;">Privilegios(Páginas) del rol</h4>
						<%foreach (var item in getPrivileges) {  %>							
							<div id="checksPrivileges" class="col-lg-3 col-md-3 col-sm-12 col-xsm-12" style="padding:10px;margin-right:15px">					    
								<div class="form-check">
									<input style="padding:10px" class="form-check-input" type="checkbox" value="<%=item.id %>" id="ckechPrivilege<%=item.id %>"  name="checksPrivileges">
									<label style="margin-left:8px" class="form-check-label" for="flexCheckChecked">
										<%=item.descripcion %>
									</label>
								</div>
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group row">
							<div class="col-md-6 col-sm-6" id="ctrl-principal">								
								<button class="btn btnDeletes reflejo" id="delete" type="button" onclick="deletePR(event)">
				...
				<input type="hidden" name="catalogo" value="privilegiosRoles" />
			</form>
			<div style="margin-top:30px;" class="x_title"></div>
			<h2>Privilegios de roles<small></small></h2>
			...
			<div id="containerTablePrivilegesRoles"></div>			
			<%-- Tabla Final--%>
		</div>
	</div>
    <script src="js/personalizados/privilegiosRoles/add.js"></script>
    <script src="js/personalizados/privilegiosRoles/buildTable.js"></script>
    <script src="js/personalizados/privilegiosRoles/delete.js"></script>
    <script src="js/personalizados/privilegiosRoles/OnkeyupSearch.js"></script>
    <script src="js/personalizados/privilegiosRoles/RecoverData.js"></script>
    <script src="js/personalizados/privilegiosRoles/update.js"></script>
    <script src="js/personalizados/privilegiosRoles/checkFullPrivileges.js"></script>
	...
	<script type="text/javascript">
		window.onload = function () {
			const json = <%=getJsonPrivilegesRoles%>
			buildTablePR(json);
    
           

            $('#checkFull input[type=checkbox]').iCheck({
            ...
            var checkFull = document.getElementById('ckechFull');
            checkFull.nextElementSibling.setAttribute('onclick', 'toggleSelectAll()');
