function buildTableRoles(jsonRoles,firstTime) {
                      ...
                      <table class="table table-striped jambo_table bulk_action" id="tbl-roles">
                        ...
                        <tbody>`;
                            for (var i = 0; i < jsonRoles.length; i++) {
                                ...
                                html += `<td class="last"><button id="${jsonRoles[i].idRol }" type="button" onclick="recoverDataa(event)" class="btn btn-success">Modificar</button></td>`
                                html += `
                                </tr> `
                            }
                        html += `</tbody>
