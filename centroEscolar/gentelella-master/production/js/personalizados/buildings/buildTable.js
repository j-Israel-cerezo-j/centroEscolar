function buildTableBuildings(json, jsonOnkeyp = true) {
    document.getElementById("containerTableBuildings").innerHTML = "";
    var ban = false;
    var cont = 1;
    var html = `
    ...
    if (ban) {
        document.getElementById("containerTableBuildings").innerHTML = html;
        initChecksTable();
        addEventCheckAll();
    } else if (!jsonOnkeyp) {
        document.getElementById("containerTableBuildings").innerHTML = "<h4 class='text-center'>No se encontro ninguna coincidencia</h4>"
    } else {
        document.getElementById("containerTableBuildings").innerHTML = "<h4 class='text-center'>Aún no hay registros agregados</h4>"
    }
