function buildTableAcademicLev(json) {
    document.getElementById("containerTableAcademicLev").innerHTML = "";
    var ban = false;
    var cont = 1;
    var html = `           
                  <div class="x_title">
                      ...
                      <table class="table table-striped jambo_table bulk_action" id="tbl-roles">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title" style="display: table-cell;">Cuatrimestre</th>                            
    ...
    if (ban) {
        document.getElementById("containerTableAcademicLev").innerHTML = html;
    } else {
        document.getElementById("containerTableAcademicLev").innerHTML = "<h4 class='text-center'>Aún no hay registros agregados</h4>"
    }
