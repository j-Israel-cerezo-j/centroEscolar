function recoverDataa(event) {
    ...
    document.getElementById("typeWorker").style.boxShadow = "0 0 0 0.25rem rgb(25 135 84 / 25%)"
...
function cancelUpdate() {
    ...
    document.getElementById("labelMsjAction").innerText = "Agregar un tipo de trabajador";
