function buildTableDivisions(json, jsonOnkeyp = true) {
    document.getElementById("containerTableDivisions").innerHTML = "";
    var ban = false;
    var cont = 1;
    var html = `           
                  <div>
    ...
    if (ban) {
        document.getElementById("containerTableDivisions").innerHTML = html;
        initChecksTable();
        addEventCheckAll();
    } else if (!jsonOnkeyp) {
        document.getElementById("containerTableDivisions").innerHTML = "<h4 class='text-center'>No se encontro ninguna coincidencia</h4>"
    } else {
        document.getElementById("containerTableDivisions").innerHTML = "<h4 class='text-center'>Aún no hay registros agregados</h4>"
    }
