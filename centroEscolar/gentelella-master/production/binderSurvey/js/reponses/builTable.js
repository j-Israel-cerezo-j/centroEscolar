function buildTableQuestionsAnswer(json, jsonOnkeyp = true) {
    document.getElementById("containerTableQuestionsAnswer").innerHTML = "";
    var ban = false;
    var cont = 1;
    var html = `           
                  <div>
                        ...
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title" style="display: table-cell;">No.</th>
                                    <th class="column-title" style="display: table-cell;">Respuesta </th>
    ...
    if (ban) {
        document.getElementById("containerTableQuestionsAnswer").innerHTML = html;
        initChecksTable();
        addEventCheckAll();
    } else if (!jsonOnkeyp) {
        document.getElementById("containerTableQuestionsAnswer").innerHTML = "<h4 class='text-center'>No se encontro ninguna coincidencia</h4>"
    } else {
        document.getElementById("containerTableQuestionsAnswer").innerHTML = "<h4 class='text-center'>Aún no hay registros agregados</h4>"
    }
