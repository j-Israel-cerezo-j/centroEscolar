<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manageCatalogOfQuestionCategories.aspx.cs" Inherits="centroEscolar.gentelella_master.production.binderSurvey.manageCatalogOfQuestionCategories" MasterPageFile="~/gentelella-master/production/binderSurvey/masterCentroEscolar.Master" %>
...
<asp:content id="Content1" ContentPlaceHolderID="bodyContent" runat="server">
	<div class="x_panel">					
		<div class="x_content">
			<h2 id="labelMsjAction">Agregar categoria de preguntas en encuestas</h2>
			<br>
			<form id="form1"  class="g-3 needs-validation" novalidate>
				<div class="row" style="margin-top:15px">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xsm-12 form-group" >														
						<input style="border-radius:6px" type="text" class="form-control has-feedback-left" id="descripcion" name="descripcion" placeholder="Escribe tu aquí..." required="required"  onkeyup="onkeyupInputEmtyy('descripcion')"/>
					...
					<div class="col-lg-6 col-md-12 col-sm-12 col-xsm-12" style="margin-top:20px;">
						<div class="form-group">
							<div style="margin-left: 0px;" class="col-md-7 col-sm-7" id="ctrl-principal">								
								<button class="btn btnDeletes reflejo" id="delete" type="button" onclick="deleteCategory(event)">
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
										<path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"></path>                                    
									</svg>
									Eliminar
								</button>
								<button type="button" class="btn btnSuccesss reflejo" id="add" onclick="addCategory()">
				...
				<input type="hidden" value="questionsCategory" name="catalogo" />
			</form>
			...
			<div id="containerTableCategorys"></div>
			<div >
				<button onclick="buildPdfOfTablee()" >Convertir a pedf </button>
			</div>
			<%-- Tabla Final--%>
		</div>
	</div>
    <script src="js/categorysQuestions/onkeyupSearch.js"></script>
    ...
    <script src="js/categorysQuestions/update.js"></script>
    <script src="js/utils/switchCatalogosRecoverData.js"></script>
    <script src="js/utils/Ajax/recoverDataAjax.js"></script>
    <script src="js/categorysQuestions/recoverData.js"></script>
    <script src="js/utils/Ajax/crudCatalogsAjax.js"></script>
    <script src="js/categorysQuestions/add.js"></script>
    <script src="js/categorysQuestions/buildTable.js"></script>
    <script src="js/categorysQuestions/delete.js"></script>
	<script src="../js/personalizados/utils/onkeyupInputEmpty.js"></script>    
    <script src="js/categorysQuestions/buidPdfOfTable.js"></script>
	<script type="text/javascript">
		window.onload = function () {
            var jsonQuestionsAnswer =<%=getJsonQuestionsCategory%>
                buildTableQuestionsCategory(jsonQuestionsAnswer)
