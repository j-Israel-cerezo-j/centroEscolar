...
<asp:content id="Content1" ContentPlaceHolderID="bodyContent" runat="server">
	<div class="x_panel">					
		<div class="x_content">
			<h2 id="labelMsjAction">Agregar rol</h2>
			<br>
			<form id="form1"  class="g-3 needs-validation" novalidate>
				<div class="row" style="margin-top:15px">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xsm-12 form-group" >								
						<input style="border-radius:6px" type="text" class="form-control has-feedback-left" required="required" name="rol" id="rol" placeholder="Agregar rol" onkeyup="onkeyupInputEmtyy('rol')">
					...
					<div class="col-lg-6 col-md-12 col-sm-12 col-xsm-12" id="divTypeWorker" data-type-worker="Tipo de trabajador">
						<%foreach (var item in getTypesWorkers)
						{%>									
								<div id="radiosTW" class="radio">											
									<div class="iradio_flat-green" style="position: relative;">
										<input type="radio" class="flat" value="<%=item.typeWorker%>" id="radio<%=item.typeWorker %>" name="typeWorker" style="position: absolute; opacity: 0;">												
					...
					<div class="col-lg-6 col-md-12 col-sm-12 col-xsm-12" style="margin-top:20px;">
						<div class="form-group">
							<div style="margin-left: 0px;" class="col-md-7 col-sm-7" id="ctrl-principal">								
								<button class="btn btnDeletes reflejo" id="delete" type="button" onclick="deleteRol(event)">
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
										<path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"></path>                                    
									</svg>
									Eliminar
								</button>
								<button type="button" class="btn btnSuccesss reflejo" id="add" onclick="addR()">
    ...
    <script src="js/personalizados/roles/onkeyupSearchh.js"></script>
    ...
    <script src="js/personalizados/serviceWorker/serviceWorker.js"></script>
    <script src="js/personalizados/Json.js"></script>         	
	<script type="text/javascript">
		var swLocation = "js/personalizados/serviceWorker/serviceWorker.js";
		function addR() {	
