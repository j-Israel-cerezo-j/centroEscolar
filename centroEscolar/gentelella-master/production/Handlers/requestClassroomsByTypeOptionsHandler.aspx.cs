...
{
    public partial class requestClassroomsByTypeOptionsHandler : System.Web.UI.Page
    {
        ...
        private void recoverData()
        {
            ...
            string strIDoption = Request.QueryString["IDoption"];
            if (strTypeClassroomOptions != "")
            {
                try
                {
                    var json = classroomService.responseClassroomOptions(strTypeClassroomOptions, strIDoption);
                    if (json != "")
                    {
