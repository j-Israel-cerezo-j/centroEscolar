...
;(function(root, factory){
    ...
    FormValidator.prototype = {
        ...
        texts : {
            ...
            checked         : 'La entrada es demasiado larga',
            empty           : 'Por favor pon algo aqui',
            select          : 'Por favor seleccione una opcion',
            number_min      : 'Demasiado baja',
            number_max      : 'Demasiado alta',
            url             : 'URL invalidaL',
            number          : 'No un numero',
            email           : 'Direccion de correo electronico es invalida',
            email_repeat    : 'Los correos no coinciden',
            date            : 'Fecha invalida',
            time            : 'Hora inválida',
            password_repeat : 'Las contrasenias no coinciden',
